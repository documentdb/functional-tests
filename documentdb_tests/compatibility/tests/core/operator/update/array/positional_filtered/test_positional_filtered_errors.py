...
class PositionalFilteredErrorTest(BaseTestCase):
    """Test case for $[<identifier>] error scenarios."""
...
MISSING_FILTERS_TESTS: list[PositionalFilteredErrorTest] = [
    PositionalFilteredErrorTest(
...
UPSERT_ERROR_TESTS: list[PositionalFilteredErrorTest] = [
    PositionalFilteredErrorTest(
...
RENAME_ERROR_TESTS: list[PositionalFilteredErrorTest] = [
    PositionalFilteredErrorTest(
...
IDENTIFIER_NAMING_ERROR_TESTS: list[PositionalFilteredErrorTest] = [
    PositionalFilteredErrorTest(
...
INTERACTION_SUCCESS_TESTS: list[PositionalFilteredErrorTest] = [
    PositionalFilteredErrorTest(
...
def test_positional_filtered_interaction_success(collection, test: PositionalFilteredErrorTest):
