...
FOUND_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        ...
        expected=True,
        msg="$in should find int in array",
    ),
    ExpressionTestCase(
        "found_first",
        doc={"val": 1, "arr": [1, 2, 3]},
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find first element",
    ),
    ExpressionTestCase(
        "found_last",
        doc={"val": 3, "arr": [1, 2, 3]},
    ...
    ExpressionTestCase(
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find string in array",
    ),
    ExpressionTestCase(
        "found_bool_true",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find true in array",
    ),
    ExpressionTestCase(
        "found_bool_false",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find false in array",
    ),
    ExpressionTestCase(
        "found_null",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find null in array",
    ),
    ExpressionTestCase(
        "found_nested_array",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find nested array",
    ),
    ExpressionTestCase(
        "found_object",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find object in array",
    ),
    ExpressionTestCase(
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find value in single-element array",
    ),
    ExpressionTestCase(
        "found_duplicate",
        doc={"val": 5, "arr": [5, 5, 5]},
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find value in array of duplicates",
    ),
]
...
NOT_FOUND_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find absent int",
    ),
    ExpressionTestCase(
        "not_found_string",
        doc={"val": "z", "arr": ["a", "b"]},
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find absent string",
    ),
    ExpressionTestCase(
        "not_found_empty_array",
        doc={"val": 1, "arr": []},
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find value in empty array",
    ),
    ExpressionTestCase(
        "not_found_type_mismatch",
        doc={"val": "1", "arr": [1, 2, 3]},
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find string '1' in int array",
    ),
    ExpressionTestCase(
        "not_found_bool_vs_int",
        doc={"val": True, "arr": [1, 0]},
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find bool in int array",
    ),
    ExpressionTestCase(
        "not_found_null",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find null in non-null array",
    ),
    ExpressionTestCase(
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find partial array match",
    ),
    ExpressionTestCase(
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find partial object match",
    ),
]
...
MIXED_TYPE_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find string in mixed-type array",
    ),
    ExpressionTestCase(
        "mixed_find_null",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find null in mixed-type array",
    ),
    ExpressionTestCase(
        "mixed_find_array",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find array in mixed-type array",
    ),
    ExpressionTestCase(
        "mixed_not_found",
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find absent value in mixed-type array",
    ),
]
...
LARGE_ARRAY_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        "large_array_found_first",
        doc={"val": 0, "arr": list(range(20_000))},
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find first element in large array",
    ),
    ExpressionTestCase(
        "large_array_found_last",
        doc={"val": 19_999, "arr": list(range(20_000))},
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find last element in large array",
    ),
    ExpressionTestCase(
        "large_array_found_middle",
        doc={"val": 10_000, "arr": list(range(20_000))},
        expression={"$in": ["$val", "$arr"]},
        expected=True,
        msg="$in should find middle element in large array",
    ),
    ExpressionTestCase(
        ...
        expression={"$in": ["$val", "$arr"]},
        expected=False,
        msg="$in should not find absent value in large array",
    ),
]
