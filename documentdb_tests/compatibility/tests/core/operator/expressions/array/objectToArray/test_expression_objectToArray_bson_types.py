...
TEST_SUBSET_FOR_LITERAL: list[ExpressionTestCase] = [
    ExpressionTestCase(
        id="value_int64",
        expression={"$objectToArray": {"a": Int64(99)}},
        doc={"obj": {"a": Int64(99)}},
    ...
    ExpressionTestCase(
        id="value_binary",
        expression={"$objectToArray": {"a": Binary(b"\x01\x02", 0)}},
    ...
    ExpressionTestCase(
        id="value_uuid",
        expression={
            "$objectToArray": {"a": Binary.from_uuid(UUID("01234567-89ab-cdef-fedc-ba9876543210"))}
        },
    ...
    ExpressionTestCase(
        id="value_infinity",
        expression={"$objectToArray": {"a": FLOAT_INFINITY}},
    ...
    ExpressionTestCase(
        id="value_int32_max",
        expression={"$objectToArray": {"a": INT32_MAX}},
        doc={"obj": {"a": INT32_MAX}},
