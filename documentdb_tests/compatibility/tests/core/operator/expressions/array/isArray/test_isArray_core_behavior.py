...
IS_ARRAY_FALSE_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for string",
    ),
    ExpressionTestCase(
        id="int",
        doc={"val": 42},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for int",
    ),
    ExpressionTestCase(
        id="double",
        doc={"val": 3.14},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for double",
    ),
    ExpressionTestCase(
        id="bool_true",
        doc={"val": True},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for true",
    ),
    ExpressionTestCase(
        id="bool_false",
        doc={"val": False},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for false",
    ),
    ExpressionTestCase(
        id="null",
        doc={"val": None},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for null",
    ),
    ExpressionTestCase(
        id="object",
        doc={"val": {"a": 1}},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for object",
    ),
    ExpressionTestCase(
        id="empty_string",
        doc={"val": ""},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for empty string",
    ),
    ExpressionTestCase(
        id="empty_object",
        doc={"val": {}},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for empty object",
    ),
    ExpressionTestCase(
        id="zero",
        doc={"val": 0},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for zero",
    ),
    ExpressionTestCase(
        id="negative_int",
        doc={"val": -123},
        expression={"$isArray": "$val"},
        expected=False,
        msg="Should return false for negative int",
    ),
    ExpressionTestCase(
        id="negative_double",
        doc={"val": -1.23},
