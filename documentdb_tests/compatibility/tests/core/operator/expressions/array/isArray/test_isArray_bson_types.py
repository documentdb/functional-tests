...
BSON_ARRAY_TRUE_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        ...
        expected=True,
        msg="$isArray should return true for BinData array",
    ),
    ExpressionTestCase(
        "timestamp_array",
        ...
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for Timestamp array",
    ),
    ExpressionTestCase(
        "int64_array",
        doc={"val": [Int64(1)]},
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for Int64 array",
    ),
    ExpressionTestCase(
        "decimal128_array",
        ...
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for Decimal128 array",
    ),
    ExpressionTestCase(
        "objectid_array",
        doc={"val": [ObjectId()]},
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for ObjectId array",
    ),
    ExpressionTestCase(
        "datetime_array",
        ...
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for datetime array",
    ),
    ExpressionTestCase(
        "minkey_array",
        doc={"val": [MinKey()]},
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for MinKey array",
    ),
    ExpressionTestCase(
        "maxkey_array",
        doc={"val": [MaxKey()]},
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for MaxKey array",
    ),
    ExpressionTestCase(
        "regex_array",
        doc={"val": [Regex(".*")]},
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for Regex array",
    ),
    ExpressionTestCase(
        "nan_array",
        doc={"val": [FLOAT_NAN]},
    ...
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for negative zero array",
    ),
    ExpressionTestCase(
        "decimal128_neg_zero_array",
        doc={"val": [DECIMAL128_NEGATIVE_ZERO]},
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for Decimal128 -0 array",
    ),
    ExpressionTestCase(
        "nested_mixed_bson_array",
        doc={
            "val": [
                MinKey(),
        ...
        expression={"$isArray": "$val"},
        expected=True,
        msg="$isArray should return true for nested mixed BSON array",
    ),
]
...
BSON_FALSE_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for Int64",
    ),
    ExpressionTestCase(
        "decimal128",
        doc={"val": Decimal128("1")},
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for Decimal128",
    ),
    ExpressionTestCase(
        "objectid",
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for ObjectId",
    ),
    ExpressionTestCase(
        "datetime",
        doc={"val": datetime(2024, 1, 1, tzinfo=timezone.utc)},
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for datetime",
    ),
    ExpressionTestCase(
        "binary",
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for Binary",
    ),
    ExpressionTestCase(
        "regex",
        doc={"val": Regex("^abc")},
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for Regex",
    ),
    ExpressionTestCase(
        "timestamp",
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for Timestamp",
    ),
    ExpressionTestCase(
        "minkey",
        doc={"val": MinKey()},
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for MinKey",
    ),
    ExpressionTestCase(
        "maxkey",
        doc={"val": MaxKey()},
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for MaxKey",
    ),
]
...
SPECIAL_NUMERIC_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for NaN",
    ),
    ExpressionTestCase(
        "inf",
        doc={"val": FLOAT_INFINITY},
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for Infinity",
    ),
    ExpressionTestCase(
        "neg_inf",
        doc={"val": FLOAT_NEGATIVE_INFINITY},
    ...
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for negative zero",
    ),
    ExpressionTestCase(
        "decimal128_nan",
        doc={"val": DECIMAL128_NAN},
    ...
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for Decimal128 Infinity",
    ),
    ExpressionTestCase(
        "decimal128_neg_inf",
        doc={"val": DECIMAL128_NEGATIVE_INFINITY},
    ...
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for Decimal128 -0",
    ),
]
...
BOUNDARY_TESTS: list[ExpressionTestCase] = [
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for INT32_MAX",
    ),
    ExpressionTestCase(
        "int32_min",
        doc={"val": INT32_MIN},
    ...
    ExpressionTestCase(
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for INT64_MAX",
    ),
    ExpressionTestCase(
        "int64_min",
        doc={"val": INT64_MIN},
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for INT64_MIN",
    ),
    ExpressionTestCase(
        "decimal128_max",
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for DECIMAL128_MAX",
    ),
    ExpressionTestCase(
        "decimal128_min",
        ...
        expression={"$isArray": "$val"},
        expected=False,
        msg="$isArray should return false for DECIMAL128_MIN",
    ),
]
