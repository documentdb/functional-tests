...
REPLACEALL_SIZE_LIMIT_SUCCESS_TESTS: list[ReplaceAllTest] = [
    ...
    ReplaceAllTest(
        ...
        input=lazy(lambda: "\U0001f600" * ((STRING_SIZE_LIMIT_BYTES - 1) // 4)),
        find="xyz",
        replacement="abc",
        expected=lazy(lambda: "\U0001f600" * ((STRING_SIZE_LIMIT_BYTES - 1) // 4)),
    ...
    ReplaceAllTest(
        ...
        input=lazy(lambda: "a" * ((STRING_SIZE_LIMIT_BYTES - 2) // 2)),
        find="",
        replacement="X",
        expected=lazy(lambda: "X" + "aX" * ((STRING_SIZE_LIMIT_BYTES - 2) // 2)),
...
REPLACEALL_SIZE_LIMIT_ERROR_TESTS: list[ReplaceAllTest] = [
    ...
    ReplaceAllTest(
        ...
        input="hello",
        find="a",
        replacement=lazy(lambda: "a" * STRING_SIZE_LIMIT_BYTES),
        error_code=STRING_SIZE_LIMIT_ERROR,
