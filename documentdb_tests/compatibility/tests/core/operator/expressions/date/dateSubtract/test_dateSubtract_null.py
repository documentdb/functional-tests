"""$dateSubtract null and missing propagation: a null or missing operand returns null."""
...
DATESUBTRACT_NULL_MISSING_TESTS: list[ExpressionTestCase] = (
    DATESUBTRACT_NULL_TESTS + DATESUBTRACT_MISSING_TESTS
)


@pytest.mark.parametrize("test_case", pytest_params(DATESUBTRACT_NULL_MISSING_TESTS))
def test_dateSubtract_null(collection, test_case: ExpressionTestCase):
    """Test $dateSubtract returns null for null literals and missing field references."""
