...
@pytest.mark.parametrize("test", pytest_params(PLANCACHECLEAR_SORT_TYPE_TESTS))
def test_planCacheClear_sort_type(database_client, collection, test):
    """Test planCacheClear command sort field type acceptance."""
