...
Validates key direction values, field names,
compound indexes, and multikey behavior.
"""
...
ALL_TESTS = KEY_DIRECTION_TESTS + KEY_FIELD_NAME_TESTS + COMPOUND_INDEX_TESTS + MULTIKEY_TESTS
